...
describe '.search' do
  context 'empty base' do
    it 'finds nothing' do
      findings = Mocktor.columns.map do |column|
        Mocktor.search(column => 'Whatever you want')
      end
